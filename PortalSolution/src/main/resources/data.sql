...
insert into user (id, email, mobile_no, password, username)  values  (103, 'whatsapp@test.com', 7023387364, '$2a$10$igKIeUe5SUwqnpEJTdzWquZHAxiFBOt8YHp7rZAtUewNuzb5iWy8y', 'whatsapp');
...
insert into  user_role  (user_id, role_id) values (103, 105);